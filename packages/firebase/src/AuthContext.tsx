...
import {pathWithBase} from '@repo/utils/path'; // Importa a função para lidar com o caminho base
...
interface AuthContextProviderProps {
  children: ReactNode;
  basePath: string; // Recebe o basePath como uma prop explícita
}
export const AuthContextProvider = ({ children, basePath }: AuthContextProviderProps) => {
      ...
      switch (provider) {
        ...
        case 'Email':
          ...
          const actionCodeSettings = {
            url: `${window.location.origin}${pathWithBase(basePath, "/loginlink")}`, // Redireciona para o dashboard após login
